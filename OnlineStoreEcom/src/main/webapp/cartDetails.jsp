 ...
 -->
	...
	<div class="container">
		...
		<table class="table table-hover">
			<thead
				style="background-color: white; color: black; font-size: 20px; font-weight: bold;">
				<tr>
					<th>Picture</th>
					<th>Products</th>
					<th>Price</th>
			...
			<tbody
				style="background-color: white; font-size: 14px; font-weight: bold;">
				...
				<tr style="background-color: white;">
					<td colspan="6" style="text-align: center; color:black">Total Amount to
						Pay (in Rupees)</td>
					<td style="color:black"><%=totAmount%></td>
				</tr>
				<%
				if (totAmount != 0) {
				%>
