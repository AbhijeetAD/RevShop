...
<body style="background-color: #E6F9E6;">
	...
	<div class="container">
		<div class="row"
			style="margin-top: 20px; margin-left: 2px; margin-right: 2px;">

			<form action="./RegisterServlet" method="post"
				class="col-md-6 col-md-offset-3"
				style=" border-radius: 30px; background-color: gray; padding: 10px;">
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: black;"><b>Registration Form</b></h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row text-center">
					<div class="col-md-6" style="margin-bottom: 2px;">
						<button type="Reset" class="btn btn-danger"  style="background-color:#253853;">Reset</button>
					</div>
					<div class="col-md-6">
						<button type="submit" class="btn btn-success" style="background-color:#303f4f;">Register</button>
					</div>
				</div>
			</form>
		</div>
