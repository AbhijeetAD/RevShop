...
public class CartServiceImpl implements CartService {
	...
	public String addProductToCart(String userId, String prodId, int prodQty) {
		...
		Connection con = com.rev.utilities.DBUtil.provideConnection();
		...
		try {
			...
			if (rs.next()) {
				...
				if (availableQty < prodQty) {
					...
					RequestData demandBean = new RequestData(userId, product.getProdId(), prodQty - availableQty);
	...
	public List<CartData> getAllCartItems(String userId) {
		List<CartData> items = new ArrayList<CartData>();
