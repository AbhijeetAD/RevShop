...
public class ProductServiceImpl implements ProductService {
	...
	public String addProduct(String prodName, String prodType, String prodInfo, double prodPrice, int prodQuantity,
		...
		ProductData product = new ProductData(prodId, prodName, prodType, prodInfo, prodPrice, prodQuantity, prodImage);
	...
	public String updateProductWithoutImage(String prevProductId, ProductData updatedProduct) {
		...
		try {
			...
			if ((k > 0) && (prevQuantity < updatedProduct.getProdQuantity())) {
				...
				List<RequestData> demandList = new RequestServiceImpl().haveDemanded(prevProductId);

				for (RequestData demand : demandList) {
					...
					boolean flag = new RequestServiceImpl().removeProduct(demand.getUserName(), prevProductId);
