		...
		<div class="row"
			...
			<form action="./AddProductServlet" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: black;">Product Add Form</h2> <br>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<label for="last_name">Stock Quantity</label> <input type="number"
							...
							class="form-control" id="last_name" min="1" max="10" step="1" required>
					</div>
				</div>
				<div>
					<div class="col-md-12 form-group">
						<label for="last_name">Product Image</label> <input type="file"
							placeholder="Select Image" accept=".png, .jpg, .jpeg" name="image" class="form-control"
							id="last_name" required>
					</div>
				</div>
				<div class="row">
